var Dashboard = function() {
    ...
    return {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        for (var i = 0; i < data.length; i++) {
                            var arrData = [];
                            arrData.push(data[i].split(',')[0]);
                            arrData.push(data[i].split(',')[1]);
                            visitors.push(arrData);
                        }
                    },
                ...
                $("#site_statistics").bind("plothover", function(event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            showChartTooltip(item.pageX, item.pageY, item.datapoint[0], item.datapoint[1] + ' transaksi');
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
        ...
        initAmChart3: function() {
            ...
            var assurances;
            function GetChartAssuranceData() {
                $.ajax({
                    url: "getChartAssuranceData/",
                    cache: false,
                    async: false,
                    type: "GET",
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_3", {
                ...
                "dataProvider": GetChartAssuranceData(),
                "valueAxes": [{
                    "axisAlpha": 0,
                    "position": "left"
                }],
        ...
        initAmChart31: function () {
            if (typeof (AmCharts) === 'undefined' || $('#dashboard_amchart_31').size() === 0) {
                return
            }
            var audits;
            function GetChartAllAudit() {
                $.ajax({
                    url: "getChartAllAudit/",
                    cache: false,
                    async: false,
                    type: "GET",
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_31", {
                "type": "serial",
                "addClassNames": true,
                "theme": "light",
                "path": "../assets/global/plugins/amcharts/ammap/images/",
        ...
        initAmChart4: function() {
            ...
            var consultings;
            function GetChartConsultingData() {
                $.ajax({
                    url: "getChartConsultingData/",
                    cache: false,
                    async: false,
                    type: "GET",
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_4", {
                ...
                "theme": "light",
                "path": "../assets/global/plugins/amcharts/ammap/images/",
                "dataProvider": GetChartConsultingData(),
                "valueField": "total",
