...
{
    [Authorize]
    public class ExcelDocumentAttribute : ActionFilterAttribute
    {
        ...
        public override void OnResultExecuted(ResultExecutedContext filterContext)
        {
            ...
            filterContext.HttpContext.Response.AppendHeader("Content-Disposition", string.Format("filename={0}.xls", filename));
            filterContext.HttpContext.Response.ContentType = "application/msexcel";
